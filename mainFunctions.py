...
def load_text():
    ...
    if text_file != '':
        with TextLoad.CustomOpen(text_file) as f:
            ...
            with TextLoad.CustomWrite('load_text.txt') as file:
            ...
            original_stdout = sys.stdout
            with TextLoad.CustomWrite('load_text_1.txt') as file:
                for key, val in enumerate(lines.split(), start=1):
                    sys.stdout = file
                    if key % 3 == 0:
                        print(val, end='\n\n')
                    ...
                    sys.stdout = original_stdout
            original_stdout = sys.stdout
            with TextLoad.CustomWrite('load_text_2.txt') as file:
                for key, val in enumerate(lines.split(), start=1):
                    sys.stdout = file
                    if key % 2 == 0:
                        print(val, end='\n\n')
                        ...
                        print(val, end=' ')
                    sys.stdout = original_stdout
            with TextLoad.CustomWrite('load_text_3.txt') as file:
                for key, val in enumerate(lines.split(), start=1):
                    sys.stdout = file
                    if key % 1 == 0:
                        print(val, end='\n\n')
...
# define a function to open the gallery
def openGallery():
    filename = 'python gallery.py'
    os.system(filename)


# define a function to open Audio
def myAudio():
    # import audioLoad
    # audioLoad.main()
